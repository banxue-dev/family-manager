...
/**
 * PersonalInfo服务层 Auther:feng Date:2020-09-28 15:37:24
 */
@Service
public class PersonalInfoServiceImpl implements IPersonalInfoService {
	...
	public PersonalInfoVO getSingleInfo(PersonalInfoDO personalInfoDO) {
		...
		personalInfo = iPersonalInfoMapper
				.selectOne(EntityChangeRquestView.createDOToEntity(personalInfoDO, new PersonalInfo()));
	...
	@Override
	@Transactional
	public LayuiPage<PersonalInfoVO> getPersonalInfoListByPage(PersonalInfoDO personalInfoDO,
			LayuiPage<PersonalInfoVO> layuiPage) {
		Example example = getPublicExample(personalInfoDO);
