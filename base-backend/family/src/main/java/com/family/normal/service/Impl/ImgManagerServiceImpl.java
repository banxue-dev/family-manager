...
/**
 * ImgManager服务层 Auther:feng Date:2020-12-16 15:47:27
 */
@Service
public class ImgManagerServiceImpl implements IImgManagerService {
	...
	public ImgManagerVO getSingleInfo(ImgManagerDO imgManagerDO) {
		...
		imgManager = iImgManagerMapper
				.selectOne(EntityChangeRquestView.createDOToEntity(imgManagerDO, new ImgManager()));
	...
	@Override
	@Transactional
	public LayuiPage<ImgManagerVO> getImgManagerListByPage(ImgManagerDO imgManagerDO,
			LayuiPage<ImgManagerVO> layuiPage) {
		Example example = getPublicExample(imgManagerDO);
